...
export default function Portfolio() {
    ...
    const paragraphs = [
        "Hola soy Leo, tengo 23 años. Ingeniero en proceso.",
        "Diseño, programo, me equivoco, y repito. Busco que lo visual y lo funcional se lleven lindo.",
        "Acá vas a encontrar una parte de todo eso. Mi trabajo, mi experiencia, y lo que me gusta."
    ];
        ...
        <div className="flex items-center justify-center min-h-screen min-w-screen font-[var(--font-martian)] bg-[#0F0E0E] relative overflow-hidden">
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto scrollbar-hide fade-edges relative">
                    ...
                    <AnimatePresence mode="wait">
                        {section === "hola" && !animando && (
                            <motion.div
                                ...
                                variants={container}
                            >
                                <motion.h2 className="text-4xl mb-8" variants={item}>Sobre mí</motion.h2>
                    ...
                    {/* Botones de redes */}
                    {section === "hola" && !animando && (
                        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-auto h-auto py-4 flex items-center justify-center gap-2 flex-wrap rounded-lg shadow-lg ">
                            <motion.div
                                initial="hidden"
                                animate="show"
                                exit="hidden"
